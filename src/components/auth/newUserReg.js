...
export default class NewUserReg extends Component {
    ...
    handleRegister = e => {
        ...
        if (this.state.userEmail !== "" && this.state.userName !== "" && this.state.userPassword === this.state.passwordCheck)
            var counter = 0
        UserManager.getAllUsers().then(au => {
            au.forEach(u => {
                if (
            ...
            if (counter < 1) {
                ...
                UserManager.postUser(newUser).then(pu => {
    ...
    render() {
        return (
            <form onSubmit={this.handleRegister}>
                ...
                <a href="http://localhost:3000/home"><img src={require("./ar15.png")} alt="" height="20%" width="20%"></img></a>
                ...
                <h2 className="h3 mb-3 font-weight-bold">Shooter Information</h2>
                <br />
